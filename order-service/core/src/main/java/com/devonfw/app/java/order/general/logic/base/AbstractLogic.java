 ...
 * application. Actual implementations need to be annotated with
...
public abstract class AbstractLogic extends AbstractBeanMapperSupport {
	 ...
	 * {@link GenericEntity entities} without an {@link GenericEntity#getId() ID}
	 * ({@code null}) will be ignored.
	 *
	 * @param          <ID> is the generic type of the {@link GenericEntity#getId()
	 *                 ID}.
	 ...
	 * <code>currentList</code> is the current list from the persistence and
	 * <code>listToSave</code> is the new list that shall be saved. In other words
	 * this method selects the {@link GenericEntity entities} from
	 ...
	 *                        entities} currently persisted. We assume that all
	 *                        objects in this list have an
	 *                        {@link GenericEntity#getId() ID} value (that is not
	 *                        {@code null}).
	 * @param entitiesToSave  is the {@link Collection} that contains the
	 *                        {@link GenericEntity entities} that shall be saved. It
	 *                        may contain {@link GenericEntity entities} that have
	 *                        no {@link GenericEntity#getId() ID} that shall be
	 *                        newly created.
